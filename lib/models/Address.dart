...
class Address extends Model {
  ...
  const Address._internal({required this.id, required street, required country, required city, required state, zipCode, user, createdAt, updatedAt}): _street = street, _country = country, _city = city, _state = state, _zipCode = zipCode, _user = user, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'street': _street, 'country': _country, 'city': _city, 'state': _state, 'zipCode': _zipCode, 'user': _user?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'street': _street, 'country': _country, 'city': _city, 'state': _state, 'zipCode': _zipCode, 'user': _user, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
